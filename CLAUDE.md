...
- V1 pHash extraction must remain bounded to the declared thumbnail dimensions and response cap. CLIP/DINO/same-subject/crop/reportage evidence cannot become grouping-authoritative without an explicit reviewed policy change and updated adversarial tests. Canonical outputs are recommendations only; never emit image deletion instructions.
