...
Offline #148 Gateway vision comparison (`openai/gpt-5.4`, `xai/grok-4.6`) is documented in [docs/vision-gateway-v1/README.md](docs/vision-gateway-v1/README.md). Frozen OCR/orientation eval is in [docs/vision-eval-v1/README.md](docs/vision-eval-v1/README.md). Image-kind and orientation provenance is in [docs/orientation-eval-v1/README.md](docs/orientation-eval-v1/README.md). Selective frontier fallback (sideways/documents only) is in [docs/fallback-v1/README.md](docs/fallback-v1/README.md). Query-time `/research` inspect fallback is in [docs/inspect-fallback-v1/README.md](docs/inspect-fallback-v1/README.md). Candidate captions stay inactive.
