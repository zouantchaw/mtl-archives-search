...
const translations = {
  fr: {
    ...
    noPaymentNow: 'Paiement sécurisé par carte à l’étape suivante. Nous préparons ensuite votre commande manuellement.',
    pricing: 'Résumé',
    sizeLine: 'Format',
    productLine: 'Type',
  ...
  en: {
    ...
    noPaymentNow: 'Secure card payment happens at the next step. We then prepare your order manually.',
    pricing: 'Summary',
    sizeLine: 'Size',
    productLine: 'Type',
