...
export const metadata: Metadata = {
  ...
  description: 'Explorez 13 000+ photos historiques de Montréal. Recherchez par rue, quartier ou lieu emblématique. Explore 13,000+ historical photos of Montreal.',
  keywords: [
...
const collectionJsonLd = {
  ...
  description: 'Collection de 13 000+ photos historiques des archives de la Ville de Montréal.',
  url: siteUrl,
  publisher: {
    '@type': 'Organization',
