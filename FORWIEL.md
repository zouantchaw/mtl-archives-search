...
Issue #100 is now merged and complete, but it is deliberately an inactive synthetic contract rather than proof of a real container environment. Issue #101 Packet 1 freezes a 69-case Linux/Podman/D1/admission checklist and its 71-file registered synthetic fixture, `dfv0_gate_h2_linux_conformance_v1_20260806`. Packet 2 completes the local synthetic/pending/nonproduction builder-receipts contract, documented in [`gate-h2-builder-receipts-v1.md`](docs/dataset-factory/gate-h2-builder-receipts-v1.md). Its fixture, `dfv0_gate_h2_builder_receipts_v1_20260806`, is exactly 4 files, 17,539 bytes, SHA-256 `c9e2b0764b1070b479836abae1c7bd2fa362ad95710e3bd02f74c23c535a6688`; its 81 ordered adversarial cases bind source identity from pinned Git objects at `4ddf00e812610e3e029059f25ad3d951577f667d`. The recipe deliberately leaves external builder-image, vendor, trust-root, and tool-artifact pins pending/null. Synthetic two-build receipts and their comparison describe a future reproducibility test; they do not prove real builds, Linux/Podman execution, or production admission. No paid host, Podman run, D1 action, credential, provider/model call, activation, publication, or deploy occurred. The next boundary is explicit approval to select and pin external build inputs, run independent real Linux/Podman builds, then perform real conformance/D1 admission.
