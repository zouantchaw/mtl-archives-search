...
| [apps/web](apps/web) | Optional similarity explorer for one published snapshot, with connection webs and a device-local collection. Not the main site. See [explorer notes](docs/explorer-modernization.md). |
