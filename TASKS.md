...
- [ ] **Visual Family Graph v1 (#67)** — Draft implementation adds an 18,462-record typed leakage graph, bounded full-corpus DCT-pHash extraction, explicit source/CLIP/DINO contracts, component-safe splits, canonical/alternate recommendations, stratified image review, search duplicate-rate evaluation, schemas, and adversarial checks. Independent threshold/leakage review remains the acceptance gate before this item can be marked complete.
