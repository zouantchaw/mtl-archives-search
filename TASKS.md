...
- [ ] Issue #101 evidence only: independently approve/supply the builder-image digest and prove Linux `SO_PEERCRED`, mandatory sealed memfds, static linkage, sandbox flags, external TLS conformance, and two-clean-source binary/rootfs/OCI byte identity before embedding production launch trust or admitting a configuration.
