...
- [x] **Set a weekly baseline** — track `order_mode_entered → cart_item_added → checkout_clicked → order_completed`. *(Events already instrumented; baseline tracking is an ops task.)*
