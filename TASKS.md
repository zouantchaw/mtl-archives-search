...
- [ ] Issue #100 implementation: implement the Podman supervisor, broker lifecycle, connected channel provisioning, D1 begin/completion chronology, and transcript/output joins.
