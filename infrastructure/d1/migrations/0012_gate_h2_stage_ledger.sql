...
CREATE TABLE gate_h2_stage_claims (
  ...
  authority_hash TEXT NOT NULL,
  stage_id TEXT NOT NULL,
  attempt_id TEXT NOT NULL UNIQUE REFERENCES gate_h2_stage_attempts(attempt_id),
...
CREATE TABLE gate_h2_stage_completions (
  ...
  authority_hash TEXT NOT NULL,
  stage_id TEXT NOT NULL,
  attempt_id TEXT NOT NULL UNIQUE REFERENCES gate_h2_stage_claims(attempt_id),
  completed_at TEXT NOT NULL,
  completion_envelope TEXT NOT NULL,
  completion_sha256 TEXT NOT NULL,
  PRIMARY KEY (candidate_commit, authority_hash, stage_id),
  FOREIGN KEY (candidate_commit, authority_hash, stage_id)
    REFERENCES gate_h2_stage_claims(candidate_commit, authority_hash, stage_id)
) STRICT;
