...
6. Provider limits or timeouts can still yield uncertain images or an explicit error. Check `research_visual_check_failed` error names in Next logs; never log credentials or full private request bodies.
