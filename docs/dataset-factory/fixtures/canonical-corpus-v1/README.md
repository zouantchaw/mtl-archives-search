...
Run `npm run canonical-corpus-v1:fixture-smoke` to copy the fixture through the collection boundary, build it twice, validate every invariant and artifact hash, and compare deterministic output bytes.
