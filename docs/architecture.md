...
- The pHash transform is bounded to 256px, a 1 MiB response cap, decoded resize enforcement, and no original-object staging. Exact payload evidence means exact normalized derivative pixels, not equality of original R2 bytes.
